...
function generateSampleData() {
  ...
  fs.writeFileSync(
    path.join(dataDir, 'user-email-index.json'),
  ...
  fs.writeFileSync(
    path.join(dataDir, 'employee-ids.json'),
...
`;
  ...
  const scriptPath = path.join(dataDir, 'import.sh');
  ...
  console.log(`- ${path.join(dataDir, 'user-email-index.json')}`);
  console.log(`- ${path.join(dataDir, 'employees.json')}`);
  console.log(`- ${path.join(dataDir, 'employee-ids.json')}`);
  console.log(`- ${path.join(dataDir, 'attendance.json')}`);
  console.log(`- ${path.join(dataDir, 'import.sh')}`);
  console.log('\nNext steps:');
